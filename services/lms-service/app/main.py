...
# Create FastAPI app
app = FastAPI(
    title="Medical Imaging LMS Service",
    description="Learning Management System for medical imaging training",
...
app.include_router(course.router, prefix="/api/v1/lms", tags=["Courses"])
app.include_router(enrollment.router, prefix="/api/v1/lms", tags=["Enrollment"])
app.include_router(assessment.router, prefix="/api/v1/lms", tags=["Assessment"])
