"""
Health check endpoints for DICOM Service
"""
...
async def detailed_health_check(db: AsyncSession = Depends(get_db)):
    ...
    try:
        ...
        if await orthanc.check_connection():
            dependencies["orthanc"] = "healthy"
        else:
            dependencies["orthanc"] = "unhealthy: connection failed"
    except Exception as e:
        dependencies["orthanc"] = f"unhealthy: {str(e)}"
